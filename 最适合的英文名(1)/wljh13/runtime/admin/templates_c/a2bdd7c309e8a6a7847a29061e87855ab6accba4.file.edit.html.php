<?php /* Smarty version Smarty-3.1.18, created on 2017-12-24 18:18:47
         compiled from "app\admin\view\Notice_Cate\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:33945a3f7f07aaff00-74765824%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a2bdd7c309e8a6a7847a29061e87855ab6accba4' => 
    array (
      0 => 'app\\admin\\view\\Notice_Cate\\edit.html',
      1 => 1511233864,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '33945a3f7f07aaff00-74765824',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3f7f07c618e3_80047420',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3f7f07c618e3_80047420')) {function content_5a3f7f07c618e3_80047420($_smarty_tpl) {?> <?php echo $_smarty_tpl->getSubTemplate ('Public/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<?php echo $_smarty_tpl->tpl_vars['value']->value["name"];?>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<select name="onepages" id="ctl00_contentHolder_ddlRecommend"
										...
										<option <?php if ($_smarty_tpl->tpl_vars['rs']->value['onepages']) {?>selected="selected" <?php }?> value="1">是</option>
										<option <?php if (!$_smarty_tpl->tpl_vars['rs']->value['onepages']) {?>selected="selected" <?php }?>value="0">否</option>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<select name="banner" id="ctl00_contentHolder_ddlRecommend"
										class="form-control productType">
										<option <?php if ($_smarty_tpl->tpl_vars['rs']->value['banner']) {?>selected="selected" <?php }?> value="1">是</option>
										<option <?php if (!$_smarty_tpl->tpl_vars['rs']->value['banner']) {?>selected="selected" <?php }?>value="0">否</option>
									</select>
						...
						<div class="form-group">
							<div class="col-md-offset-4 col-md-9">
								...
								<input type="button" value="返回" onclick="location='?c=Notice_Cate'"
									class="btn btn-primary" />
							</div>
						</div>
					</div>
