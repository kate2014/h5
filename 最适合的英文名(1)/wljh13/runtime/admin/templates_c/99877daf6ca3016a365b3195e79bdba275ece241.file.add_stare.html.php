<?php /* Smarty version Smarty-3.1.18, created on 2017-11-25 11:35:30
         compiled from "app\admin\view\Notice\add_stare.html" */ ?>
<?php /*%%SmartyHeaderCode:86085a18e50208a615-24668295%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99877daf6ca3016a365b3195e79bdba275ece241' => 
    array (
      0 => 'app\\admin\\view\\Notice\\add_stare.html',
      1 => 1511504776,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '86085a18e50208a615-24668295',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a18e502201669_51879728',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a18e502201669_51879728')) {function content_5a18e502201669_51879728($_smarty_tpl) {?> <?php echo $_smarty_tpl->getSubTemplate ('Public/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
"><?php echo $_smarty_tpl->tpl_vars['value']->value['name'];?>
							...
							<!-- <div class="form-group">
								<label class="control-label col-md-3">首页热推图片上传</label>
								<div class="col-md-6">
...
resource/js/zh_CN.js"></script>
										...
										<input type="hidden" id="url_fileUpload" name="file" class="form-control" value="" />
							...
							<div class="form-group">
								<label class="control-label col-md-3">项目详情图片上传</label>
								<div class="col-md-6">
									<span id="ctl00_contentHolder_fileUpload" style="display: inline-block;">
										<script charset="utf-8" src="resource/kindeditor/kindeditor-min.js"></script>
										<script charset="utf-8" src="<?php echo $_smarty_tpl->tpl_vars['tpl_path']->value;?>
resource/js/zh_CN.js"></script>
										...
										<input type="hidden" id="url_thumbUpload" name="thumb" class="form-control" value="" />
							...
							<div class="form-group">
								<label class="control-label col-md-3">是否热推：</label>
								<div class="col-md-4">
									<select name="hide" id="ctl00_contentHolder_ddlRecommend"
										class="form-control productType">
										<option selected="selected" value="0">否</option>
										<option value="1">是</option>
