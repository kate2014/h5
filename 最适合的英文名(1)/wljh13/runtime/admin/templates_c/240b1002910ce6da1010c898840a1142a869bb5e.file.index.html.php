<?php /* Smarty version Smarty-3.1.18, created on 2017-10-18 18:24:20
         compiled from "app\admin\view\AboutUs\index.html" */ ?>
<?php /*%%SmartyHeaderCode:3073159e72bd42a67a5-98878175%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '240b1002910ce6da1010c898840a1142a869bb5e' => 
    array (
      0 => 'app\\admin\\view\\AboutUs\\index.html',
      1 => 1506411023,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3073159e72bd42a67a5-98878175',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e72bd4431087_51239373',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e72bd4431087_51239373')) {function content_59e72bd4431087_51239373($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Public/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>


<form name="aspnetForm" method="post" action="?c=AboutUs&cateid=<?php echo $_smarty_tpl->tpl_vars['cateid']->value;?>
" id="aspnetForm">
		...
		<div id="panel-collapse-4" class="collapse in" style="height: auto;">
			<div class="panel-body">
				<div class="btn-toolbar top-table" style="margin-bottom: 0px"
					role="toolbar">
					<div class="btn-group">
						<a class="btn  btn-default" href="?c=AboutUs&act=add&cateid=<?php echo $_smarty_tpl->tpl_vars['cateid']->value;?>
">
...
?>
								<tr>
									...
									<td class="spanD spanN" style="width: 110px;">
										<a id="ctl00_contentHolder_grdProductTypes_ctl02_lkbViewAttribute" title="编辑" class="btn-default" href="?c=AboutUs&act=edit&cateid=<?php echo $_smarty_tpl->tpl_vars['cateid']->value;?>
	...
	function del(id)
	{
		if (confirm("确定要删除这条数据吗？"))
			$.post("?c=Notice&act=del",{
				id:id},function(data){
					if(data)
						location="?c=AboutUs&cateid=<?php echo $_smarty_tpl->tpl_vars['cateid']->value;?>
";	
				})
