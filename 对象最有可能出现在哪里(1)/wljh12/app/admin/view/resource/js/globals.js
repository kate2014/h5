var otherJS = 'app/admin/view/resource/js/jquery.msgbox.js'; //js的地址，请自定义
document.write('<script type="text/javascript" src="' + otherJS + '"></script>');
document.write('<script type="text/javascript" src="app/admin/view/resource/js/jquery.dragndrop.min.js"></script>');
function msgShow(msg, Width, Height) {
    new $.msgbox({
        type: 'alert',
        width: Width,
        height: Height,
