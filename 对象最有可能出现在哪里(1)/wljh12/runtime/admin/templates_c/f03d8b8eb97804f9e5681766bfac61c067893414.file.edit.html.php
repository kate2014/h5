<?php /* Smarty version Smarty-3.1.18, created on 2017-09-25 10:03:27
         compiled from "app\admin\view\Training\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:2842059c863ef7034c8-08576732%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f03d8b8eb97804f9e5681766bfac61c067893414' => 
    array (
      0 => 'app\\admin\\view\\Training\\edit.html',
      1 => 1506136140,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2842059c863ef7034c8-08576732',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c863ef7d8ee4_19444426',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c863ef7d8ee4_19444426')) {function content_59c863ef7d8ee4_19444426($_smarty_tpl) {?> <?php echo $_smarty_tpl->getSubTemplate ('Public/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<form name="aspnetForm" method="post" action="?c=Training&act=save" id="aspnetForm">
...
" id="imglogo_fileUpload" />
							...
							<div class="form-group">
								...
								<div class="demo2" style="padding-top:7px;">
									...
									<input name="begin" placeholder="请输入日期" class="laydate-icon" onClick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"  value="<?php echo date('Y-m-d',$_smarty_tpl->tpl_vars['rs']->value['begin']);?>
">
							...
							<div class="form-group">
								...
								<div class="demo2" style="padding-top:7px;">
									...
									<input name="closure" placeholder="请输入日期" class="laydate-icon" onClick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" value="<?php echo date('Y-m-d',$_smarty_tpl->tpl_vars['rs']->value['closure']);?>
">
						...
						<div class="form-group">
							<div class="col-md-offset-4 col-md-9">
								...
								<input type="button" value="返回" onclick="location='?c=Training'" class="btn btn-primary" />
							</div>
						</div>
					</div>
				</div>
