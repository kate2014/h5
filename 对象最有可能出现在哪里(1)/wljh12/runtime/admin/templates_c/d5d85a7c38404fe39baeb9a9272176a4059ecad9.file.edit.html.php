<?php /* Smarty version Smarty-3.1.18, created on 2017-09-24 17:48:54
         compiled from "app\admin\view\AboutUs\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:2583959c77f868fe427-29514928%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd5d85a7c38404fe39baeb9a9272176a4059ecad9' => 
    array (
      0 => 'app\\admin\\view\\AboutUs\\edit.html',
      1 => 1506049451,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2583959c77f868fe427-29514928',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c77f869d3e47_57522687',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c77f869d3e47_57522687')) {function content_59c77f869d3e47_57522687($_smarty_tpl) {?> <?php echo $_smarty_tpl->getSubTemplate ('Public/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
" />
							...
							<?php if ($_smarty_tpl->tpl_vars['rs']->value['extra']) {?>
							<div class="form-group">
								<label class="control-label col-md-3">电话</label>
								<div class="col-md-4">
									<input name="tell" type="text" maxlength="30" id="ctl00_contentHolder_txtTypeName" placeholder="" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['rs']->value['tell'];?>
" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4">
									<input name="phone" type="text" maxlength="30" id="ctl00_contentHolder_txtTypeName" placeholder="" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['rs']->value['phone'];?>
" />
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input name="email" type="text" maxlength="30" id="ctl00_contentHolder_txtTypeName" placeholder="" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['rs']->value['email'];?>
" />
									<small>联系我们 页面填写</small>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4">
									<input name="website" type="text" maxlength="30" id="ctl00_contentHolder_txtTypeName" placeholder="" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['rs']->value['website'];?>
" />
									<small>联系我们 页面填写</small>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4">
									<input name="address" type="text" maxlength="30" id="ctl00_contentHolder_txtTypeName" placeholder="" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['rs']->value['address'];?>
" />
									<small>联系我们 页面填写</small>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4">
									<input name="latitude" type="text" maxlength="30" id="ctl00_contentHolder_txtTypeName" placeholder="" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['rs']->value['latitude'];?>
" />
									<small>联系我们 页面填写</small><a target="_blank" href="http://www.gpsspg.com/maps.htm">获取经纬度</a>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3">经度</label>
								<div class="col-md-4">
									<input name="longitude" type="text" maxlength="30" id="ctl00_contentHolder_txtTypeName" placeholder="" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['rs']->value['longitude'];?>
" />
									<small>联系我们 页面填写</small>
								</div>
							</div>
...
" id="imglogo_fileUpload" />
						...
						<div class="form-group">
							<div class="col-md-offset-4 col-md-9">
								...
								<input type="button" value="返回" onclick="location='?c=AboutUs&cateid=<?php echo $_smarty_tpl->tpl_vars['cateid']->value;?>
