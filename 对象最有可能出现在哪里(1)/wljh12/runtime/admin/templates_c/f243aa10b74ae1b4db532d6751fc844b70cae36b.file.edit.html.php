<?php /* Smarty version Smarty-3.1.18, created on 2017-12-25 13:38:26
         compiled from "app\admin\view\Message\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:176215a408ed22412d7-34288150%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f243aa10b74ae1b4db532d6751fc844b70cae36b' => 
    array (
      0 => 'app\\admin\\view\\Message\\edit.html',
      1 => 1514172990,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '176215a408ed22412d7-34288150',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a408ed24dd2f6_67383952',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a408ed24dd2f6_67383952')) {function content_5a408ed24dd2f6_67383952($_smarty_tpl) {?> <?php echo $_smarty_tpl->getSubTemplate ('Public/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<form name="aspnetForm" method="post" action="?c=Message&act=save&id=<?php echo $_smarty_tpl->tpl_vars['rs']->value['id'];?>
" id="aspnetForm">
					...
					<div class="tab-content form-horizontal" style="margin-top: 15px;">
						<div class="form-body">
							<div class="form-group">
								...
								<div class="col-md-4">
									<input name="name" type="text" maxlength="30" id="ctl00_contentHolder_txtTypeName" placeholder="长度限制在1-30个字符之间" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['rs']->value['name'];?>
" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4">
									<input name="content" type="text" maxlength="30" id="ctl00_contentHolder_txtTypeName" placeholder="长度限制在1-30个字符之间" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['rs']->value['content'];?>
" />
								</div>
							</div>
...
" />
						...
						<div class="form-group">
							<div class="col-md-offset-4 col-md-9">
								...
								<input type="button" value="返回" onclick="location='?c=Message&id=<?php echo $_smarty_tpl->tpl_vars['rs']->value['id'];?>
'"
									class="btn btn-primary" />
							</div>
						</div>
