<?php /* Smarty version Smarty-3.1.18, created on 2018-01-02 14:48:24
         compiled from "app\admin\view\Notice\index.html" */ ?>
<?php /*%%SmartyHeaderCode:181045a4b2b38a612f3-60930197%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '181045a4b2b38a612f3-60930197',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4b2b38c1e867_41107683',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4b2b38c1e867_41107683')) {function content_5a4b2b38c1e867_41107683($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('Public/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
						...
						<div>
							<table cellspacing="0"
								...
								<tr class="table_title">
									<th class="td_right td_left" scope="col">公众号</th>
									<th class="td_right td_left" scope="col">文章类型</th>
									<th class="td_right td_left" scope="col">二维码图片</th>
									<th class="td_right td_left" scope="col">链接</th>
									<?php if ($_smarty_tpl->tpl_vars['cate_id']->value=='6'||$_smarty_tpl->tpl_vars['cate_id']->value=='9'||$_smarty_tpl->tpl_vars['cate_id']->value=='8'||$_smarty_tpl->tpl_vars['cate_id']->value=='10') {?>
									<th class="td_right td_left" scope="col">热销推荐</th>
									<?php }?>
...
?>
                                    ...
                                    <?php }?>
								<td><img src="<?php echo $_smarty_tpl->tpl_vars['value']->value['thumb'];?>
" width="120" height="120"/></td>
								<td>/cate_id=<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
</td>
                                    <?php } ?>
                                    <!--<?php  $_smarty_tpl->tpl_vars['value2'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value2']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
...
?>
                                    ...
                                    <?php } ?>-->
									<?php if ($_smarty_tpl->tpl_vars['cate_id']->value=='6'||$_smarty_tpl->tpl_vars['cate_id']->value=='9'||$_smarty_tpl->tpl_vars['cate_id']->value=='8'||$_smarty_tpl->tpl_vars['cate_id']->value=='10') {?>
                                    <?php if ($_smarty_tpl->tpl_vars['value']->value['retui']=='0') {?>
                                    <td>否</td>
									<?php } elseif ($_smarty_tpl->tpl_vars['value']->value['retui']=='1') {?>
									<td>是</td>
                                    <?php }?>
									<?php }?>
